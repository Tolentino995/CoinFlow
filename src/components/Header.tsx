    ...
    return (
        <header className="w-full bg-white/90 backdrop-blur-md border-b border-gray-100 sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Lado Izquierdo: Logo (Ahora es un enlace al inicio) */}
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <Link to={"/"} className="px-6 py-2.5 text-sm font-medium text-gray-600 bg-white border border-gray-200 rounded-full hover:bg-gray-50 hover:text-gray-900 transition-all duration-200">
                    Overview
                    </Link>
                    
                    {/* Botón Watchlist (Estilo Sólido Cian / Botón principal) */}
                    <Link to={"watchlist"} className="px-6 py-2.5 text-sm font-medium text-white bg-cyan-500 rounded-full hover:bg-cyan-600 shadow-md shadow-cyan-500/20 hover:shadow-lg hover:shadow-cyan-500/40 transition-all duration-200">
                    Watchlist
                    </Link>
                </div>
